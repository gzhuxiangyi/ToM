...
import jmetal.metaheuristics.moead.CMOEAStudy;
import jmetal.metaheuristics.moead.MultiPlot;
...
//        System.out.println(storePath_);
	...
	public static void main(String[] args) throws JMException, ClassNotFoundException {
		...
		String [] paretoFrontFile_ = new String[problemList_.length]; 
	    
	    for (int i = 0; i < problemList_.length; i++) {      
	    	paretoFrontFile_[i] = problemList_[i] + ".pf";                   
	    } // for i
...
//				"ro","bs","gd","c^","k>","mv"
		...
		String experimentName = "./jmetalExperiment/PPSStudy/M=" + objectives;
