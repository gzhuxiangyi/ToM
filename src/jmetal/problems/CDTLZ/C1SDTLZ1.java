 ...
 */
public class C1SDTLZ1 extends Problem {   
 /** 
  * Creates a default C1DTLZ1 problem (7 variables and 3 objectives)
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public C1SDTLZ1(String solutionType) throws ClassNotFoundException {
...
//    this(solutionType, 19, 15);//15 objectives 
  ...
  /** 
  * Creates a C1DTLZ1 problem instance
  * @param numberOfVariables Number of variables
  * @param numberOfObjectives Number of objective functions
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public C1SDTLZ1(String solutionType, 
               Integer numberOfVariables, 
  		         Integer numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    numberOfConstraints_= 1;
    problemName_        = "C1SDTLZ1";
  ...
  */    
  ...
  public void evaluateConstraints(Solution solution) throws JMException {
    ...
    constraint[0] =  1 - f[numberOfObjectives_-1]/0.6 - sum      ;
