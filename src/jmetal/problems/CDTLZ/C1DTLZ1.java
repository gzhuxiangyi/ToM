 ...
 */
public class C1DTLZ1 extends Problem {   
 /** 
  * Creates a default C1DTLZ1 problem (7 variables and 3 objectives)
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public C1DTLZ1(String solutionType) throws ClassNotFoundException {
...
//    this(solutionType, 19, 15);//15 objectives 
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public C1DTLZ1(String solutionType, 
               Integer numberOfVariables, 
  		         Integer numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    numberOfConstraints_= 1;
    problemName_        = "C1DTLZ1";
