...
/**
 * Class representing problem CDTLZ2Convex
 */
public class C2DTLZ2Convex extends Problem{
       
 /** 
  * Creates a default convex C2DTLZ2Convex  problem (12 variables and 3 objectives)
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public C2DTLZ2Convex(String solutionType) throws ClassNotFoundException {
...
//    this(solutionType, 24, 15);//15 objectives  
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public C2DTLZ2Convex(String  solutionType,
               Integer numberOfVariables,
               Integer numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    numberOfConstraints_= 1;
    problemName_        = "C2DTLZ2Convex";
