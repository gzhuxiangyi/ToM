...
/**
 * Class representing problem DC3DTLZ3
 */
public class DC3DTLZ3 extends Problem{
  
 /**
  * Creates a default DC3DTLZ3 problem (12 variables and 3 objectives)
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public DC3DTLZ3(String solutionType) throws ClassNotFoundException {
...
//  this(solutionType, 24, 15);//15 objectives  
  ...
  /**
  * Creates a new DC3DTLZ3 problem instance
  * @param numberOfVariables Number of variables
  * @param numberOfObjectives Number of objective functions
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public DC3DTLZ3(String  solutionType,
               Integer numberOfVariables,
               Integer numberOfObjectives) {
    numberOfVariables_   = numberOfVariables;
    numberOfObjectives_  = numberOfObjectives;
    numberOfConstraints_ = numberOfObjectives + 1;
    problemName_         = "DC3DTLZ3";
