...
/** 
 * Class representing CMOP3 problem  
 */
public class CMOP3 extends Problem {   
 /** 
  * Creates a default CMOP3 problem (15 variables and 2 objectives)
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public CMOP3(String solutionType) throws ClassNotFoundException {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal". 
  */
  public CMOP3(String solutionType,  Integer numberOfVariables,  Integer numberOfObjectives) {
  ...
  */    
  public void evaluate(Solution solution) throws JMException {
    ...
    f[0] = g2 * Math.pow(x[0], n);
    f[1] = g2 * (1 - (f[0]/g2) *  (f[0]/g2));    
     ...
     */
    constraint[0] =  - (2 - 4 * f[0] * f[0] - f[1]) * (2 - 8 * f[0] * f[0] - f[1]);//
    constraint[1] =   (2 - 2 * f[0] * f[0] - f[1]) * (2 - 16 * f[0] * f[0] - f[1]);//
    constraint[2] =   (1 - 1 * f[0] * f[0] - f[1]) * (1.2 - 1.2 * f[0] * f[0] - f[1]);//
