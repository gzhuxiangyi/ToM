...
public class CTsMOEADR1Release extends Algorithm {
	...
	private double eps_  = 0.1;        // A small positive number, used in defining ideal or nadir points
	 ...
	 */
	public CTsMOEADR1Release(Problem problem) {
		super(problem);		
	} // CTaMOEAD
...
//					  problem_.getNumberOfObjectives());	
		...
		System.out.println("=============Running CTs-MOEA R1=============");
...
//			populationSize_ += 1;	
		...
		System.out.println("CTs-MOEA Release maxEvaluations = " +  maxEvaluations_);		
		System.out.println("CTs-MOEA Release popsize = " +  populationSize_ );		
