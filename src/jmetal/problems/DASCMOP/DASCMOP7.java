...
/**
 * Class representing problem DASCMOP7
 */
public class DASCMOP7 extends Problem {

	private double[] DifficultyFactors;
	/**
	 * Creates an DASCMOP7 problem (30 variables and 2 objectives)
	 *
	 * @param solutionType
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public DASCMOP7(String solutionType, double[] difficultyFactors) throws ClassNotFoundException {
		this(solutionType, 30, 3, difficultyFactors);
	} // DASCMOP7

	/**
	 * Creates an DASCMOP7 problem instance
	 *
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public DASCMOP7(String solutionType, Integer numberOfVariables,
