...
/**
 * Class representing problem DASCMOP3
 */
public class DASCMOP3 extends Problem {

	private double[] DifficultyFactors;
	/**
	 * Creates an DASCMOP3 problem (30 variables and 2 objectives)
	 *
	 * @param solutionType
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public DASCMOP3(String solutionType, double[] difficultyFactors) throws ClassNotFoundException {
		this(solutionType, 30, 2, difficultyFactors);
	} // DASCMOP3

	/**
	 * Creates an DASCMOP3 problem instance
	 *
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public DASCMOP3(String solutionType, Integer numberOfVariables,
...
//		}
		...
		f[0] = x[0] + sum ;
		f[1] = 1.0 - Math.sqrt(x[0]) + 0.5 * Math.abs(Math.sin(5.0 * Math.PI * x[0])) + sum;
