...
/**
 * Class representing problem DASCMOP2
 */
public class DASCMOP2 extends Problem {

	private double[] DifficultyFactors;
	/**
	 * Creates an DASCMOP2 problem (30 variables and 2 objectives)
	 *
	 * @param solutionType
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public DASCMOP2(String solutionType, double[] difficultyFactors) throws ClassNotFoundException {
		this(solutionType, 30, 2, difficultyFactors);
	} // DASCMOP2

	/**
	 * Creates an DASCMOP2 problem instance
	 *
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public DASCMOP2(String solutionType, Integer numberOfVariables,
