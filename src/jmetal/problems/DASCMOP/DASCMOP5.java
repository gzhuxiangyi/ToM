...
/**
 * Class representing problem DASCMOP5
 */
public class DASCMOP5 extends Problem {

	private double[] DifficultyFactors;
	/**
	 * Creates an DASCMOP5 problem (30 variables and 2 objectives)
	 *
	 * @param solutionType
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public DASCMOP5(String solutionType, double[] difficultyFactors) throws ClassNotFoundException {
		this(solutionType, 5, 2, difficultyFactors);
	} // DASCMOP5

	/**
	 * Creates an DASCMOP5 problem instance
	 *
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public DASCMOP5(String solutionType, Integer numberOfVariables,
