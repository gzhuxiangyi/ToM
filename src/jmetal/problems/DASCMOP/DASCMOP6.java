...
/**
 * Class representing problem DASCMOP6
 */
public class DASCMOP6 extends Problem {

	private double[] DifficultyFactors;
	/**
	 * Creates an DASCMOP6 problem (30 variables and 2 objectives)
	 *
	 * @param solutionType
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public DASCMOP6(String solutionType, double[] difficultyFactors) throws ClassNotFoundException {
		this(solutionType, 30, 2, difficultyFactors);
	} // DASCMOP6

	/**
	 * Creates an DASCMOP6 problem instance
	 *
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public DASCMOP6(String solutionType, Integer numberOfVariables,
	...
	public void evaluate(Solution solution) throws JMException {
		...
		sum1 = (temp_k + sum1);
		f[0] = x[0] + sum1 ;
		f[1] = 1.0 - Math.sqrt(x[0]) + 0.5 * Math.abs(Math.sin(5.0 * Math.PI * x[0])) +  sum1;
