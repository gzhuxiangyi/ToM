...
/**
 * Class representing problem DASCMOP9
 */
public class DASCMOP9 extends Problem {

	private double[] DifficultyFactors;
	/**
	 * Creates an DASCMOP9 problem (30 variables and 2 objectives)
	 *
	 * @param solutionType
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public DASCMOP9(String solutionType, double[] difficultyFactors) throws ClassNotFoundException {
		this(solutionType, 30, 3, difficultyFactors);
	} // DASCMOP9

	/**
	 * Creates an DASCMOP9 problem instance
	 *
	 ...
	 *            The solution type must "Real" or "BinaryReal".
	 */
	public DASCMOP9(String solutionType, Integer numberOfVariables,
	...
	public void evaluate(Solution solution) throws JMException {
		...
		for (int i = numberOfObjectives_ - 1; i < numberOfVariables_; i++)
			gx += Math.pow(x[i] - Math.cos(0.25 * pi * (i + 1) * (x[0] + x[1]) / numberOfVariables_),2);
