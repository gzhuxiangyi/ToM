...
/**
 * Class representing problem Gripper5
 */
public class Gripper5 extends Problem {
    /**
     * Creates an Gripper5 problem (30 variables and 2 objectives)
     *
     * @param solutionType The solution type must "Real" or "BinaryReal".
     */
    public Gripper5(String solutionType) throws ClassNotFoundException {
        this(solutionType, 7, 2);
    } // Gripper5

    /**
     * Creates an Gripper5 problem instance
     *
     * @param numberOfVariables  Number of variables
     * @param numberOfObjectives Number of objective functions
     * @param solutionType       The solution type must "Real" or "BinaryReal".
     */
    public Gripper5(String solutionType, Integer numberOfVariables,
                    Integer numberOfObjectives) throws ClassNotFoundException {
        numberOfVariables_ = numberOfVariables.intValue();
        numberOfObjectives_ = numberOfObjectives.intValue();
        numberOfConstraints_ = 8;
        problemName_ = "Gripper5";
    ...
    public void evaluate(Solution solution) throws JMException {
        ...
        double f1 = 100 / (Math.max(min_f,1e-6));
        double f2 = - Math.abs((y[1] - y[0]) / (z[1] - z[0]));
