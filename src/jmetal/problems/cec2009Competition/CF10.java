...
/**
 * Class representing problem CF10
 */
public class CF10 extends Problem {
	/**
	 * Creates an CF10 problem (10 variables and 2 objectives)
	 * 
	 * @param solutionType
	...
	/**
	 * Creates an CF10 problem instance
	 * 
	...
	public void evaluateConstraints(Solution solution) throws JMException {
		...
		double constraint = (f[0]*f[0]+f[1]*f[1])/(1-f[2]*f[2]) 
				- a*Math.sin(N*Math.PI*((f[0]*f[0]-f[1]*f[1])/(1-f[2]*f[2])+1.0)) + 1.0;
