...
/**
 * Class representing problem CF7
 */
public class CF7 extends Problem {
	/**
	 * Creates an CF7 problem (10 variables and 2 objectives)
	 * 
	 * @param solutionType
	...
	/**
	 * Creates an CF7 problem instance
	 * 
	...
	public void evaluateConstraints(Solution solution) throws JMException {
		...
		cons[0] = x1 - Math.sin(6.0*x0*Math.PI+2.0*Math.PI/nx) 
				- Math.signum((x0-0.5)*(1.0-x0))*Math.sqrt(Math.abs((x0-0.5)*(1.0-x0)));
		cons[1] = x3 - Math.sin(6.0*x0*Math.PI+4.0*Math.PI/nx)
