...
public class DASCMaOP7 extends WFG {
    ...
    /**
     * Creates a default DASCMaOP7 problem with
     ...
     */
    public DASCMaOP7(String solutionType, double[] difficultyFactor) throws ClassNotFoundException {
        this(solutionType, 10, 20, 5, difficultyFactor) ;
    } // DASCMaOP7

    public DASCMaOP7(String solutionType, int objNo, double[] difficultyFactors) throws ClassNotFoundException {
        this(solutionType, 10, 20, objNo, difficultyFactors) ;
    } // DASCMaOP7

    /**
     * Creates a DASCMaOP7 problem instance
     *
     ...
     * @param solutionType The solution type must "Real" or "BinaryReal".
     */
    public DASCMaOP7(String solutionType, Integer k, Integer l, Integer M, double[] difficultyFactor) throws ClassNotFoundException {
        super(solutionType, k, l, M);
        this.solutionType = solutionType;
        problemName_ = "DASCMaOP7";
