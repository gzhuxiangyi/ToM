...
/**
 * This class implements the DASCMaOP4 problem
 ...
 */
public class DASCMaOP4 extends WFG {
    ConstraintSetting constraintFunction;
    double[] difficultyTriple;
    String solutionType;

    /**
     * Creates a default DASCMaOP4 with
     ...
     */
    public DASCMaOP4(String solutionType, double[] difficultFactor) throws ClassNotFoundException {
        this(solutionType, 10, 20, 5, difficultFactor) ;
    } // DASCMaOP4

    public DASCMaOP4(String solutionType, int objNo, double[] difficultyFactors) throws ClassNotFoundException {
        this(solutionType, 10, 20, objNo, difficultyFactors) ;
    } // DASCMaOP4

    /**
     * Creates a DASCMaOP4 problem instance
     *
     ...
     * @param solutionType The solution type must "Real" or "BinaryReal".
     */
    public DASCMaOP4(String solutionType, Integer k, Integer l, Integer M, double[] difficultyFactor) throws ClassNotFoundException {
        super(solutionType, k, l, M);
        this.solutionType = solutionType;
        problemName_ = "DASCMaOP4";
