...
public abstract class Problem implements Serializable {
  ...
  protected String fullProblemName_ ;
...
public String getFullProblemName() {
	return fullProblemName_;
}

public void setFullProblemName(String fullProblemName_) {
	this.fullProblemName_ = fullProblemName_;
}
