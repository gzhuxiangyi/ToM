...
public class SolutionSet implements Serializable {
  ...
  */
   ...
   * @param path The output file name
   */
  public void printObjectivesToFileAppend(String path){
    try {
      /* Open the file */
  ...
  public SolutionSet GetInfeasible(){
    ...
    public double GetFeasible_Ratio() {
	    double result = 0.0;
	    for (Solution aSolutionsList_ : solutionsList_) {
	      if (aSolutionsList_.getOverallConstraintViolation() == 0.0 && aSolutionsList_.getNumberOfViolatedConstraint() == 0 ) {
	        result+=1;
	      }
	    }
...
//      } // indexWorst
    ...
    public double MaxOverallConViolationNew(){
        if ((solutionsList_ == null) || (this.solutionsList_.isEmpty())) {
          return -1;
        }
        ...
        Comparator temp = new Comparator() {
          ...
          public int compare(Object o1, Object o2) {
            Solution a = (Solution) o1;
            Solution b = (Solution) o2;
            double cva = Math.abs(a.getOverallConstraintViolation());
    		double cvb = Math.abs(b.getOverallConstraintViolation());
        ...
        return Math.abs(worstKnown.getOverallConstraintViolation());
