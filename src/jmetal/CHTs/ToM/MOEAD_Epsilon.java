...
//	 this.runTimes++;
    ...
    System.out.println("MOEAD-Epsilon maxEvaluations = " +  maxEvaluations_);		
	System.out.println("MOEAD-Epsilon popsize = " +  populationSize_ );		
	
	if (convergenceFlag == true) 
		  captureConvergence_ = new CaptureConvergence(problem_.getName(), "MOEADEpsilon", problem_.getNumberOfObjectives());	
...
//				System.out.print(newSolution.toString() + " \n");
  ...
  void updateProblem(Solution indiv, int id, int type) {
    ...
    for (int i = 0; i < size; i++) {
      ...
      /***** This part epsilon constraint handling*****/
