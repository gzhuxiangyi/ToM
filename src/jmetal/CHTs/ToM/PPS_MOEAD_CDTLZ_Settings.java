...
import jmetal.CMOEAs.PPS_MOEAD;
 ...
 */
public class PPS_MOEAD_CDTLZ_Settings extends Settings {
    ...
    // MOEAD_SR parameters
    public double srFactor_ = 0.5;
    
    public double tao_ = 0.1;
    public double alpha_ = 0.9;
    public double threshold_ = 1e-3;
    
    // IDEA parameter
    public float infeasibleRatio_ = 0.1f;
   ...
   * Constructor
   */
  public PPS_MOEAD_CDTLZ_Settings(String problem, Object[] problemParams) {
    super(problem);

    try {
	    problem_ = (new ProblemFactory()).getProblem(problem, problemParams);
    } catch (JMException e) {
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new PPS_MOEAD(problem_);
    ...
    algorithm.setInputParameter("tao", tao_);
    algorithm.setInputParameter("alpha", alpha_);

    algorithm.setInputParameter("threshold_change", threshold_);
