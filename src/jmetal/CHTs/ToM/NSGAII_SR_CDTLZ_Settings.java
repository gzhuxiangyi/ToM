 ...
 */
public class NSGAII_SR_CDTLZ_Settings extends Settings {
   ...
   * Constructor
   */
  public NSGAII_SR_CDTLZ_Settings(String problem, Object[] problemParams) {
    super(problem);
    //-------------------------------------------
...
//  String realProbName = problem.substring(0, pos);   
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new NSGAII_SR(problem_);
