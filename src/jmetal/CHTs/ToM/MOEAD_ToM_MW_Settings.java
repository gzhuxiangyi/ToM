 ...
 */
public class MOEAD_ToM_MW_Settings extends Settings {
   ...
   * Constructor
   */
  public MOEAD_ToM_MW_Settings(String problem, Object[] problemParams) {
    super(problem);
    //-------------------------------------------
...
//    String realProbName = problem.substring(0, pos);   
    ...
    if (problem_.getNumberOfObjectives() == 2) {
    	popSize_ = 100   ; maxFES_ = 60000 ;
//    	popSize_ = 300   ;  
//    	maxFES_ = 300000 ;
    } else if(problem_.getNumberOfObjectives() == 3){	
    	popSize_ = 105   ;  maxFES_ = 63000 ; // Convergence study is 63000
//    	popSize_ = 300   ;  
//    	maxFES_ = 300000 ;
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new MOEAD_ToM(problem_);
