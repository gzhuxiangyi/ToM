...
//		        bw.newLine();
		        ...
		        bw.write("set(gcf,'Position',[500 200 350 350])"); // ����ͼ����ʾλ��
		        bw.newLine();
		        ...
		        bw.newLine();
		        if(objectives_==2){
		        	bw.write("plot(trueFront(:,1),trueFront(:,2),'bo','LineWidth',0.5,'MarkerSize',2)");
		           	bw.newLine();
...
//		        	bw.write("trueFront = trueFront(1:10000,:);");
//		        	bw.newLine();
		        	bw.write("plot3(trueFront(:,1),trueFront(:,2),trueFront(:,3),'b.','LineWidth',3,'MarkerSize',4)");
		        	bw.newLine();
				        ...
				        bw.write(frontName +" = [ ");
					      ...
					      for(int i=0;i<rowsApproximateFront;i++){
					        ...
					        if(objectives_==2){
					        	...
					        	temp = temp + ",'LineWidth',1,'MarkerSize',5)"; // 
					        	
//					        	temp = temp + ",'LineWidth',1,'MarkerSize',8,'MarkerFaceColor',"
//					        			+ "[.7 .7 .7],'MarkerEdgeColor','k')"; // PF�߽���ɫ

//					        	temp = temp + ",'LineWidth',1,'MarkerSize',7,'MarkerFaceColor',"
//					        			+ "[0.7 0.7 0.7],'MarkerEdgeColor','k')"; // PS��һ����ɫ
					        	
					        	bw.write(temp);bw.newLine();
					        	
					        	//bw.write("plot(trueFront(:,1),trueFront(:,2),'bo','LineWidth',0.5,'MarkerSize',1)");
...
//					        	                 + ",'MarkerFaceColor'" + ",[1 1 1]);";
					        	...
					        	// old code end
					        	if (frontIndex == 0) {
						        	temp = temp + ",'LineWidth',1,'MarkerSize',4,'MarkerFaceColor',"
						        			+ "[1 0.8 0.8],'MarkerEdgeColor','r')"; // �����ɫ
					        	} else {					        	
						        	
						        	temp = temp + ",'LineWidth',1,'MarkerSize',5,'MarkerFaceColor','r','MarkerEdgeColor','k')"; // �����ɫ
//						        	temp = temp + ",'LineWidth',1.5,'MarkerSize',6, 'MarkerEdgeColor',";
//						        	temp = temp + "'" + property_[frontIndex].substring(0, 1)+"');" ;
					        		
//					            	temp = temp + ",'LineWidth',1,'MarkerSize',6,'MarkerFaceColor',"
//						        			+ "[0.0 0.0 0.0],'MarkerEdgeColor','k')"; // �����ɫ
...
//			        	bw.write(" tit = title('Pareto front of problem "+problemName_+"');"); // ������Ϊ����
//			        	bw.write(" tit = title(' " + algNames_[0]  + "on" + problemName_ + "');"); // ���㷨Ϊ����
			        	bw.write(" tit = title(' " + algNames_[0]  + "');"); // ���㷨Ϊ����
//			        	bw.write(" tit = title(' " + problemName_ + "');"); // ���㷨Ϊ����
			        }
