 ...
 */
public class CNSGAIII_CDTLZ_Settings extends Settings {
    ...
    public int divisionsOuter_;
    public int divisionsInner_;
  /**
   * Constructor
   */
  public CNSGAIII_CDTLZ_Settings(String problem, Object[] problemParams) {
    super(problem);
    //-------------------------------------------
...
//  String realProbName = problem.substring(0, pos);   
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new CNSGAIII(problem_);

    // Algorithm parameters
    algorithm.setInputParameter("populationSize", popSize_);
    algorithm.setInputParameter("maxEvaluations", maxFES_);
    algorithm.setInputParameter("div1", divisionsOuter_);
    algorithm.setInputParameter("div2", divisionsInner_);
