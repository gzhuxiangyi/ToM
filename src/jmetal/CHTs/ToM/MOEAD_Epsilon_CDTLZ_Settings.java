 ...
 */
public class MOEAD_Epsilon_CDTLZ_Settings extends Settings {
   ...
   * Constructor
   */
  public MOEAD_Epsilon_CDTLZ_Settings(String problem, Object[] problemParams) {
    super(problem);
    //-------------------------------------------
...
//    String realProbName = problem.substring(0, pos);   
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new MOEAD_Epsilon(problem_);
