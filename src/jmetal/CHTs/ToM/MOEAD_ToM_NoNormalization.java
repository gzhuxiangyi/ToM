//  MOEAD_ToM_NoNormalization.java
//
//  Author:
...
// the CDP method.
public class MOEAD_ToM_NoNormalization extends Algorithm {
   ...
   */
  public MOEAD_ToM_NoNormalization(Problem problem) {
    super (problem) ;
//    functionType_ = "_TCHE1";
    functionType_ = "_PBI";
  } // MOEAD_ToM_NoNormalization
  ...
  public SolutionSet execute() throws JMException, ClassNotFoundException {
    ...
    System.out.println("MOEAD-ToM-NoNormalization maxEvaluations = " +  maxEvaluations_);		
	System.out.println("MOEAD-NoNormalization popsize = " +  populationSize_ );		
