 ...
 */
public class MOEAD_CDP_CDTLZ_Settings extends Settings {
   ...
   * Constructor
   */
  public MOEAD_CDP_CDTLZ_Settings(String problem, Object[] problemParams) {
    super(problem);
    //-------------------------------------------
...
//    String realProbName = problem.substring(0, pos);   
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new MOEAD_CDP(problem_);
