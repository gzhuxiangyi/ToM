 ...
 */
public class NSGAII_ToM_DAS_Settings extends Settings {
   ...
   * Constructor
   */
  public NSGAII_ToM_DAS_Settings(String problem, Object[] problemParams) {
    super(problem);
    //-------------------------------------------
...
//    String realProbName = problem;
    ...
    problem_.setFullProblemName(problem);
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new NSGAII_ToM(problem_);
