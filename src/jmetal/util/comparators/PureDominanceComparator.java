 ...
 */
public class PureDominanceComparator implements Comparator {
  IConstraintViolationComparator violationConstraintComparator_ ;
 
  /**
   * Constructor
   */
  public PureDominanceComparator() {
   ...
   * @param comparator
   */
  public PureDominanceComparator(IConstraintViolationComparator comparator) {
