 ...
 */
public class OverallConstraintViolationComparatorAbs1 
  ...
  */
  ...
  public boolean needToCompare(Solution s1, Solution s2) {
    ...
    needToCompare = (Math.abs(s1.getOverallConstraintViolation()) > 0) ||
            (Math.abs(s2.getOverallConstraintViolation()) > 0);
