 ...
 */
public class LooseOverallConstraintViolationComparator 
  ...
  */
  public int compare(Object o1, Object o2) {    
    ...
    if ((overall1 < -1e-6) && (overall2 < -1e-6)) {
    ...
    } else if ((overall1 > -1e-6) && (overall2 < -1e-6)) {
      return -1;
    } else if ((overall1 < -1e-6) && (overall2 > -1e-6)) {        
      return 1;
    } else {
  ...
  public boolean needToCompare(Solution s1, Solution s2) {
    ...
    needToCompare = (s1.getOverallConstraintViolation() < -1e-6) ||
            (s2.getOverallConstraintViolation() < -1e-6);
